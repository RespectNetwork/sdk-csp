...
public class CSPInformationPERFTestCsp extends BasicCSPInformation {

	private static final long serialVersionUID = -1186435920408698291L;

	public CSPInformationPERFTestCsp() {
		...
		super(
				...
				"http://perf-registration-vpc.elasticbeanstalk.com/graph",
